...
- **Repo slug:** `julianken/language-agent`; local folder is `language-agent/`.
...
| `repoSlug` | string | **required** | — | GitHub `owner/repo` slug. For this instance: `julianken/language-agent`. |

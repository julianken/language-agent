...
language-agent is a personal, non-commercial, solo-maintained open-source
project — an AI agent that teaches you to read Modern Standard Arabic through a conversation that blends English and Arabic. There is no backend, no accounts, no personal data

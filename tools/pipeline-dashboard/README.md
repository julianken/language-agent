...
Committed Node tracking server + dashboard for the language-agent feature pipeline.
...
|---|---|
| `julianken/language-agent` | GitHub `owner/repo` slug, e.g. `myorg/my-product` |
| `language-agent` | Short product display name, e.g. `My Product` |

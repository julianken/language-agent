...
| [`figma.md`](./figma.md) | `mFjP4XMgcvdwzloZL9EMze` set (blank disables) | Reading a Figma design system over the read-only MCP | your design source of truth isn't Figma |
